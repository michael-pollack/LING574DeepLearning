...
class DeepAveragingNetwork(nn.Module):
    ...
    def forward(self, bag_of_words: Tensor, lengths: Tensor) -> Tensor:
        ...
        averages = ops.divide(bag_of_words, lengths)
        embedding = self.embeddings(averages)
        hidden1 = ops.relu(self.hidden1(embedding))
        hidden2 = ops.relu(self.hidden2(hidden1))
